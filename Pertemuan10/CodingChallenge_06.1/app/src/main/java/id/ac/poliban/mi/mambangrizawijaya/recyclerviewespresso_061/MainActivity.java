package id.ac.poliban.mi.mambangrizawijaya.recyclerviewespresso_061;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("RecyclerView EspressoTest_mambang");
