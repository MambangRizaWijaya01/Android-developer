package id.ac.poliban.mi.mambangrizawijaya.twoactivitiesespresso_061;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.mambangrizawijaya.twoactivitiesespresso_061.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("TwoActivities EspressoTest_mambang");
