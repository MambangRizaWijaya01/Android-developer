package id.ac.poliban.mi.mambangrizawijaya.roomwordssampledelete;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.mambangrizawijaya.roomwordssampledelete.REPLY";
